/**
 * The project-scoped R2 key layout shared by the control and public storage
 * planes.
 *
 * Keep identifiers as individual path segments. Apart from making the layout
 * easy to inspect, this prevents a caller from accidentally escaping a
